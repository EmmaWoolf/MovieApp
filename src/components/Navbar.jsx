...
const Navbar = () => {
  // const currentUser = {displayName: "Emma Woolf"};
  ...
  return(
    <>
   <nav className="w-full flex fl
  ex-wrap items-center justify-between text-white py-3 bg-gray-900 shadow-lg navbar navbar-expand-lg fixed-top">
